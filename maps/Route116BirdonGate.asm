...
Route116BirdonGate_MapEvents:
	...
	object_event  4,  2, SPRITE_ROCKET, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_GRAY, OBJECTTYPE_SCRIPT, 0, Route116BirdonGateRocket1Script, EVENT_103_SLOWPOKE_SALESMAN
	object_event  5,  2, SPRITE_ROCKET, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, PAL_NPC_GRAY, OBJECTTYPE_SCRIPT, 0, Route116BirdonGateRocket2Script, EVENT_103_SLOWPOKE_SALESMAN
