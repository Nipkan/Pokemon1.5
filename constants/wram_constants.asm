...
; wStatusFlags2::
	...
	const STATUSFLAGS2_REACHED_WESTPORT_F      ; 6
	const STATUSFLAGS2_ROCKETS_IN_SANSKRIT_F    ; 7
...
; wNihonBadges::
	...
	const GLACIERBADGE
	const RISINGBADGE
NUM_NIHON_BADGES EQU const_value
...
; wSWIslandsBadges::
	...
	const VOLCANOBADGE
	const EARTHBADGE
NUM_SWISLANDS_BADGES EQU const_value
NUM_BADGES EQU NUM_NIHON_BADGES + NUM_SWISLANDS_BADGES
...
; wDailyFlags1::
	...
	const DAILYFLAGS1_WESTPORT_UNDERGROUND_BARGAIN_F ; 6
...
; wDailyFlags2::
	...
	const DAILYFLAGS2_WESTPORT_UNDERGROUND_GOT_HAIRCUT_F ; 2
	const DAILYFLAGS2_WESTPORT_DEPT_STORE_TM27_RETURN_F  ; 3
	const DAILYFLAGS2_DAISYS_GROOMING_F                   ; 4
	const DAILYFLAGS2_DAILY_MOVE_TUTOR_F        ; 5
